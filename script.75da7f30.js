...
var api_url = "https://dujour.squiz.cloud/developer-challenge/data"; // Defining async function
...
function show(data) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var r = _step.value;
      tab += "<tr> \n    <td>".concat(r.id, " </td>\n    <td>").concat(r.name, "</td>\n    <td>").concat(r.country, "</td> \n    <td>").concat(r.industry, "</td> \n    <td>").concat(r.numberOfEmployees, "</td>          \n</tr>");
...
function filterValues() {
  ...
  countryTxt = "";
  industryTxt = ""; // Loop through all table rows, and hide those who don't match the search query
